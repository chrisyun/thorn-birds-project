...
public class GroupDAO extends MyPassBaseDAO {
	...
	return this.jdbcTemplate.update(sql, group.getName(), group.getPname(), group.getVersion(), group.getUsername());
    }
	...
	return this.jdbcTemplate.update(sql, group.getName(), group.getPname(), group.getVersion(), group.getUsername(), group.getId());
    }
