...
public class LoginDialog {
    ...
    public LoginDialog() {
        ...
        loginDialog.setBounds(PositionUtils.locationInCenter(ComponentReference
                .getMainFrame().getBounds(), 280, 160));
        ...
        JComboBox userCombo = new JComboBox(new String[] { "chenyun",
                "zhengzhuo" });
