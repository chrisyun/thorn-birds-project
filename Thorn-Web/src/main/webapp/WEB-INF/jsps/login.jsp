...
<head>
	...
	.bg {
		background-image: url(<%=path%>/resources/images/local/login-bg.jpg);
	...
	<script type="text/javascript" src="<%=path%>/plugins/local/mouseUtils.js" ></script>
</head>
...
<script type="text/javascript">
	...
	var indexUrl = sys.path + "/main.jhtml";
