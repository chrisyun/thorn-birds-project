var logPageUrl = sys.path + "/wf/permisson/saveOrModifyPermission.jmt";
var exportUrl = sys.path + "/wf/permisson/deletePermission.jmt";
var exportUrl = sys.path + "/wf/permisson/getPermissionPage.jmt";
