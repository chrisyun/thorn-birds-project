$(function() {
	...
	for ( var i = 0; i < navArray.length; i++) {
		...
		$("#_navigationBar").append('<li><a href="' + sys.path + nav.targetUrl 
				+ '" id="_nav_' + nav.id + '">' + nav.text + '</a></li>');
	...
	} else if(paths[1] == "CMS" || paths[1] == "System" || paths[1] == "System") {
		$("#_nav_" + paths[1]).addClass("active");
	}
	
	$("#_nav_mySetting > ul > li > a").each(function(){
