...
--  Records 
-- ----------------------------
INSERT INTO `persistent_logins` VALUES ('ADMIN','juyQQqdUNVxsmKQvCavp0Q==','zWy3rNISdONV8rewGnhb7Q==','2012-05-16 22:48:59');
INSERT INTO `t_sys_dict` VALUES ('BJ','北京','1','AREA'),  ('COMMONUSER','普通用户','1','DEFAULTROLE'),  ('COMPANY','公司',NULL,'ORGTYPE'),  ('DEPT','部门','1','ORGTYPE'),  ('femme','女','1','GENDER'),  ('HB','湖北','2','AREA'),  ('HN','湖南','3','AREA'),  ('male','男','0','GENDER'),  ('NO','否','1','YESORNO'),  ('ORG','组织','2','ORGTYPE'),  ('SYSADMIN','系统管理员',NULL,'DEFAULTROLE'),  ('tree-dd','字典图标','2','ICONCLS'),  ('tree-org','组织图标','1','ICONCLS'),  ('tree-user','用户图标',NULL,'ICONCLS'),  ('YES','是',NULL,'YESORNO');
...
INSERT INTO `t_sys_resource` VALUES ('0','ALL','/**','YES','NO','-1','99',NULL),  ('DICT','数据字典管理','system/dd/dd.jsp','YES','YES','SYS','2','tree-dd'),  ('NAV','应用菜单',NULL,'NO','YES','0','0',NULL),  ('ORG','组织管理','system/org/org.jsp','YES','YES','SYS','3','tree-org'),  ('SOURCE','资源管理','system/resource/source.jsp','YES','YES','SYS','4',NULL),  ('SYS','系统管理',NULL,'NO','YES','0','0',NULL),  ('USER','用户管理','system/user/user.jsp','YES','YES','SYS','1','tree-user');
