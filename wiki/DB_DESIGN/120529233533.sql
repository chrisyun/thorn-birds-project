...
--  Records 
-- ----------------------------
INSERT INTO `persistent_logins` VALUES ('ADMIN','nW+agGjrVAfeyVVUlZaA3Q==','W1cqHiiEYij66Z9DwB3V+g==','2012-05-29 23:06:16');
...
INSERT INTO `t_sys_resource` VALUES ('0','ALL','/**','YES','NO','-1','99',''),  ('APPLOG','操作日志','system/log/appLog.jsp','YES','YES','SYS','6','tree-appLog'),  ('APPLOG-EXCEL','操作日志导出','/log/exportLogExcel.jmt','YES','NO','APPLOG','999',NULL),  ('APPLOG-QUERY','操作日志查询','/log/getLogPage.jmt','YES','NO','APPLOG','999',NULL),  ('AUTH','用户授权','system/role/userAuth.jsp','YES','YES','SYS','5','tree-auth'),  ('AUTH-ADD','添加用户','/user/saveUserRole.jmt','YES','NO','AUTH','999',''),  ('AUTH-DELETE','删除用户','/user/deleteUserRole.jmt','YES','NO','AUTH','999',''),  ('AUTH-QUERY','授权关系查询','/user/get*.jmt','YES','NO','AUTH','999',''),  ('DICT','数据字典管理','system/dd/dd.jsp','YES','YES','SYS','0','tree-dd'),  ('DICT-DELETE','数据字典删除','/dd/delete*.jmt','YES','NO','DICT','999',''),  ('DICT-QUERY','数据字典查询','/dd/get*.jmt','YES','NO','DICT','999',''),  ('DICT-UPDATE','数据字典更新','/dd/saveOrModify*.jmt','YES','NO','DICT','999',''),  ('MYPWD','修改密码','system/user/changePwd.jsp','YES','YES','NAV','99','tree-pwd'),  ('MYPWD-CHANGE','密码修改','/user/changePwd.jmt','YES','NO','MYPWD','999',''),  ('NAV','应用菜单','','NO','YES','0','0',''),  ('ORG','组织管理','system/org/org.jsp','YES','YES','SYS','2','tree-org'),  ('ORG-DELETE','组织删除','/org/delete*.jmt','YES','NO','ORG','999',''),  ('ORG-QUERY','组织查询','/org/get*.jmt','YES','NO','ORG','999',''),  ('ORG-UPDATE','组织更新','/org/saveOrModify*.jmt','YES','NO','ORG','999',''),  ('ROLE','角色管理','system/role/role.jsp','YES','YES','SYS','4','tree-role'),  ('ROLE-AUTH','角色授权','/role/saveAuth.jmt','YES','NO','ROLE','999',''),  ('ROLE-DELETE','角色删除','/role/delete*.jmt','YES','NO','ROLE','999',''),  ('ROLE-QUERY','角色查询','/role/get*.jmt','YES','NO','ROLE','999',''),  ('ROLE-UPDATE','角色更新','/role/saveOrModify*.jmt','YES','NO','ROLE','999',''),  ('SOURCE','资源管理','system/resource/source.jsp','YES','YES','SYS','1','tree-source'),  ('SOURCE-DELETE','资源删除','/resource/delete*.jmt','YES','NO','SOURCE','999',''),  ('SOURCE-QUERY','资源查询','/resource/get*.jmt','YES','NO','SOURCE','999',''),  ('SOURCE-UPDATE','资源更新','/resource/saveOrModify*.jmt','YES','NO','SOURCE','999',''),  ('SYS','系统管理','','NO','YES','0','0',''),  ('USER','用户管理','system/user/user.jsp','YES','YES','SYS','3','tree-user'),  ('USER-DELETE','用户删除','/user/deleteUser.jmt','YES','NO','USER','999',''),  ('USER-DISABLED','用户启/禁用','/user/disabled*.jmt','YES','NO','USER','999',''),  ('USER-PWD','密码修改','/user/changeMyPwd.jmt','YES','NO','USER','999',''),  ('USER-QUERY','用户查询','/user/get*.jmt','YES','NO','USER','999',''),  ('USER-ROLE','用户角色管理','/user/saveRoleByUser.jmt','YES','NO','USER','999',''),  ('USER-UPDATE','用户更新','/user/saveOrModify*.jmt','YES','NO','USER','999','');
INSERT INTO `t_sys_role` VALUES ('COMMONUSER','普通用户','普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通普通','NO'),  ('SYSADMIN','系统管理员',NULL,'NO');
INSERT INTO `t_sys_role_res` VALUES ('COMMONUSER','MYPWD','2012-05-19 19:50:03'),  ('COMMONUSER','ORG','2012-05-19 19:50:03'),  ('COMMONUSER','SOURCE','2012-05-19 19:50:03'),  ('COMMONUSER','USER','2012-05-19 19:50:02'),  ('COMMONUSER','USER-JMT','2012-05-19 19:50:03'),  ('SYSADMIN','0','2012-05-19 19:52:14'),  ('SYSADMIN','DICT','2012-05-19 19:51:51'),  ('SYSADMIN','MYPWD','2012-05-19 19:51:51'),  ('SYSADMIN','ORG','2012-05-19 19:51:51'),  ('SYSADMIN','ROLE','2012-05-19 19:51:51'),  ('SYSADMIN','SOURCE','2012-05-19 19:51:51'),  ('SYSADMIN','USER','2012-05-19 19:51:51'),  ('SYSADMIN','USER-DELETE','2012-05-19 19:51:51'),  ('SYSADMIN','USER-JMT','2012-05-19 19:51:51');
INSERT INTO `t_sys_user` VALUES ('ADMIN','系统管理员','陈','CHENYUN','6994d5fd8501c8576fcfd99c3386f085','male','chenyun313@163.com','18701309727','ROOT','YES','NO','0','SYSADMIN'),  ('AINAN','艾楠','艾','ainan','67de2274915e33d54ae338ffdabeee76',NULL,'ainan@163.com',NULL,'0021','YES','NO',NULL,'COMMONUSER'),  ('ZHENGYQ','张亚奇','张','zhangyq','77b01f654f188c182c6b6b28dffe8df8','male','zhengyq@163.com',NULL,'0021','YES','NO',NULL,'COMMONUSER');
INSERT INTO `t_sys_user_role` VALUES ('AINAN','SYSADMIN','2012-05-21 21:18:36'),  ('TEST','COMMONUSER','2012-05-24 21:03:40'),  ('ZHENGYQ','COMMONUSER','2012-05-22 22:57:13');
